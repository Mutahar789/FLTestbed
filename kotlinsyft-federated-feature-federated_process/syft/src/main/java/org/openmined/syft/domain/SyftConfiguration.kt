...
class SyftConfiguration internal constructor(
    ...
    class SyftConfigBuilder(private val context: Context, baseUrl: String){
        ...
        private var socketClient = SocketClient(baseUrl, 1000000u, networkingSchedulers)
        ...
        fun setMeasurementCallback(callback: (String, String) -> Unit): SyftConfigBuilder {
            this.measurementCallback = callback
            HttpClient.setMeasurementCallback(callback)
            return this
        }
