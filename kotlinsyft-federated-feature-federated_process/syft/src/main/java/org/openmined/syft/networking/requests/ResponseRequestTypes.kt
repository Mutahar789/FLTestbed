...
import org.openmined.syft.networking.datamodels.syft.FCM_TYPE
...
import org.openmined.syft.networking.datamodels.syft.TokenRequest
import org.openmined.syft.networking.datamodels.syft.TokenResponseData
...
internal sealed class REQUESTS(override val value: String) : ResponseMessageTypes() {
    ...
    object TOKEN_FCM_SAVE : REQUESTS(FCM_TYPE) {
        override fun parseJson(jsonString: String): NetworkModels =
                jsonParser.parse(TokenResponseData.serializer(), jsonString)

        override fun serialize(obj: NetworkModels) =
                jsonParser.toJson(TokenRequest.serializer(), obj as TokenRequest)
    }
