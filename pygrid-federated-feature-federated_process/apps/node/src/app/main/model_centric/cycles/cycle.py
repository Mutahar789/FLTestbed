...
class Cycle(BaseModel):
    ...
    cycle_start_key = db.Column(db.String(2048))
    ...
    def __str__(self):
        return f"< Cycle id : {self.id}, sequence: {self.sequence}, start: {self.start}, end: {self.end}, fl_process_id: {self.fl_process_id}, is_completed: {self.is_completed}>, cycle_start_key: {self.cycle_start_key}"
