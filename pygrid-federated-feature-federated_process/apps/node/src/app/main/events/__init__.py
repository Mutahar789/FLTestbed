...
routes = {
    ...
    MODEL_CENTRIC_FL_EVENTS.SAVE_FCM_TOKEN: save_fcm_device_registration_token,
    MODEL_CENTRIC_FL_EVENTS.UPDATE_WORKER_ONLINE_STATUS: update_worker_online_status,
    MODEL_CENTRIC_FL_EVENTS.UPLOAD_STATS: upload_file,
